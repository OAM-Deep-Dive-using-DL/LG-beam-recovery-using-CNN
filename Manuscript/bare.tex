...
\newcommand{\figdblone}{1.0\textwidth}% Fig.~1: comprehensive system model (full span)
...
\end{tabular}
\vspace{0.5mm}
\parbox{0.95\columnwidth}{\footnotesize\textit{Legend:} $C_n^2$ denotes the refractive-index structure parameter (units: m$^{-2/3}$).}
\end{table}
