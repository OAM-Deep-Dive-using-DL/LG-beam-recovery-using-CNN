...
class SimulationConfig:
    ...
    """
    # --- Optical Parameters ---
    WAVELENGTH = 1550e-9  # [m] 1550nm (C-band)
    W0 = 25e-3           # [m] 25mm transmitter aperture waist
    
    # --- Link Parameters ---
    DISTANCE = 1000      # [m] 1km benchmark distance
    RECEIVER_DIAMETER = 0.3  # [m] 30cm receiver aperture
    ...
    NUM_SCREENS = 20    # Number of phase screens (realistic for strong turb)
    
    # --- Weather Condition ---
    WEATHER = 'clear'    # 'clear' isolates turbulence effects
    
    # --- Communication Parameters ---
    FEC_RATE = 0.8      # LDPC code rate
    PILOT_RATIO = 0.1   # 10% pilot overhead
    N_INFO_BITS = 4096  # Number of information bits per frame
    
    # --- Simulation Grid ---
    N_GRID = 1024        # 1024x1024 grid for high-fidelity
    OVERSAMPLING = 2    # Grid "guard band"
    
    # --- Receiver Configuration ---
    EQ_METHOD = 'zf'    # 'zf' (Zero-Forcing) or 'mmse'
    ADD_NOISE = True    # Enable/disable noise
...
if __name__ == "__main__":
    ...
    config.SNR_DB = 25
    config.N_GRID = 512
    config.NUM_SCREENS = 10
    config.N_INFO_BITS = 1024 
